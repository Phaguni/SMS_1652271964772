...
import ExamsController from "../controllers/SMS_db/ExamsController";
import LessonsController from "../controllers/SMS_db/LessonsController";
import StudentsController from "../controllers/SMS_db/StudentsController";
import SubjectsController from "../controllers/SMS_db/SubjectsController";
import TeachersController from "../controllers/SMS_db/TeachersController";
import TestController from "../controllers/SMS_db/TestController";
...
class Server {
 ...
 // End Init Database
    ...
    // Start Init Controllers
		...
		ExamsController.init(router);
		LessonsController.init(router);
		StudentsController.init(router);
		SubjectsController.init(router);
		TeachersController.init(router);
		TestController.init(router);
